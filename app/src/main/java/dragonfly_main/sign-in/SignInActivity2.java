...
import com.example.dragonfly_main.databinding.ActivitySignInBinding;
...
public class SignInActivity2 extends BaseActivity2 implements View.OnClickListener {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SignInActivity2.this, "Sign In Failed",
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SignInActivity2.this, "Sign Up Failed",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void onAuthSuccess(FirebaseUser user) {
        ...
        // Go to MainActivity
        startActivity(new Intent(SignInActivity2.this, MainActivity2.class));
        finish();
    }
